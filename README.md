...
**Sender side** (the box that will eventually be the QUICochet client/Iran-side):
...
**Receiver side** (the box that will eventually be the QUICochet server/foreign-side):
